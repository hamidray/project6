...
module.exports = (req,res,next) => {
    ...
    .then(sauce => {
        if(req.body.like==1 && sauce.usersLiked.indexOf(req.body.userId)<0) {
            ...
            message = "You don't have a preference for sauce "+sauce.name+"!";
        }
        req.body.sauce = sauce;
        req.body.message = message
        next();
    })
    .catch(error => res.status(400).json({ error: "There was an error in the data analysis!"}));
}
